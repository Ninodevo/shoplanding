          ...
          <div className="mk-container max-w-2xl">
            ...
            <div className="prose-shop mt-10 space-y-5 text-[17px] leading-relaxed text-[var(--ink-2)]">
              ...
              <p>
                ...
                Then I built the renderer + the Shopify theme + the
                WooCommerce template that ship every one of those rules out
                of the box.
              </p>
              ...
              <ul className="space-y-2 pl-0">
                ...
                <li>A WooCommerce single-product page template — drop it into your active block theme.</li>
