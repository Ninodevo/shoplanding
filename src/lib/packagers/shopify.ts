...
function buildReadme(input: PackagerInput): string {
  return [
    ...
    "",
    "This theme ships with **placeholder** content in every block that makes a",
    "claim about a third party. Fill each one with something true, or delete",
    "the section. Do not publish the placeholders, and never invent any of it:",
    "",
    "- **Press / As seen in** — real publications that actually covered you. No",
    "  coverage yet? Delete the section.",
    "- **Reviews** — real customer reviews only. Only tick *Verified badge* for a",
    "  genuinely verified purchase. Leave the aggregate rating and review count",
    "  blank until you have real ones.",
    "- **Social wall (UGC)** — real posts from real accounts. Keep a screenshot of",
    "  each original so you can prove it.",
    "- **Comparison table** — claims you can substantiate about your product and",
    "  the alternative.",
    "",
    "Publishing invented reviews, testimonials, or press endorsements is illegal",
    "in most markets — it is specifically prohibited by the US FTC's rule on fake",
    "reviews and testimonials and by the EU Omnibus Directive. This is your",
    "store's liability, so take the five minutes.",
    "",
    "**The same goes for the product copy.** Benefits, ingredients, specs and FAQ",
    "answers ship as *example* copy showing the shape of a strong page — they",
    "describe a fictional demo product, not yours. Rewrite every one to match",
    "what you actually sell. Pay particular attention to anything that states a",
    ...
    "categories and are especially scrutinised for supplements, skincare, and",
    "anything health-adjacent. If you cannot substantiate it, cut it.",
    "",
    "## Install",
    "",
    ...
    "",
    "Your preset's copy (headlines, FAQ questions, spec labels, benefit cards …)",
    "is pre-loaded into the product template as a starting point — edit every",
    "line in **Customize → Sections** so it describes your actual product.",
    "Press logos, reviews, social posts and comparison claims ship as",
    "placeholders on purpose; see the warning at the top of this file.",
    "",
    "## System spec inside",
    "",
